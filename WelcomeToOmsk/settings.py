"""
Django settings for WelcomeToOmsk project.
...
SECRET_KEY = 'i4=5&wr$r$*#$(hzu&0xeyiij%sf(9k@hq7pe-!n5i@5tyw4qs'
...
ROOT_URLCONF = 'WelcomeToOmsk.urls'
...
WSGI_APPLICATION = 'WelcomeToOmsk.wsgi.application'
